...
print(connect.update('''CREATE TABLE IF NOT EXISTS `girls` ( `id` int(11) NOT NULL AUTO_INCREMENT,  `pothopath` varchar(77) DEFAULT NULL,  `score` double DEFAULT '1400',  `comNum` int(11) DEFAULT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;'''))
